...
import { FaArrowLeft, FaGithub, FaUsers, FaUserPlus, FaCodeBranch, FaCode, FaMapMarkerAlt, FaGlobe, FaTwitter } from 'react-icons/fa'
                    ...
                    <div className='rounded-lg shadow-xl card image-full'>
                        ...
                        <div className='card-body justify-end'>
                            <h2 className='card-title mb-0'>
                                {name}
                                <div className='ml-2 mr-1 badge badge-secondary'>
                                    {type}
                                </div>
                                {hireable && (
                                    <div className='mx-1 badge badge-secondary'>
                                        Hireable
                                    </div>
                                )}
                            </h2>
